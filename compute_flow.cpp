...
/*
#include </home/yinghan/opencv/modules/core/include/opencv2/core.hpp>
#include "/home/yinghan/opencv/modules/video/include/opencv2/video/tracking.hpp"
#include "/home/yinghan/opencv/modules/imgproc/include/opencv2/imgproc.hpp"
#include "/home/yinghan/opencv/modules/highgui/include/opencv2/highgui.hpp"
#include "/home/yinghan/opencv/modules/core/include/opencv2/core/cuda.hpp"
#include "/home/yinghan/opencv/modules/cudaoptflow/include/opencv2/cudaoptflow.hpp"
#include <dirent.h>
...
#include "/home/yinghan/opencv/modules/core/include/opencv2/core/cuda.hpp"
#include "/home/yinghan/opencv/modules/cudaoptflow/include/opencv2/cudaoptflow.hpp"
#include "/home/yinghan/opencv/modules/features2d/include/opencv2/features2d.hpp"
#include "/home/yinghan/opencv/modules/cudaarithm/include/opencv2/cudaarithm.hpp"
#include "/home/yinghan/opencv/modules/cudacodec/include/opencv2/cudacodec.hpp"

#include "/home/yinghan/opencv/modules/calib3d/include/opencv2/calib3d.hpp"
#include "/home/yinghan/opencv_contrib/modules/xfeatures2d/include/opencv2/xfeatures2d.hpp"
*/
#include <stdio.h>
#include <iostream>
using namespace std;
...
std::string vid_path = "/home/yinghan/Downloads/TH14_validation_set_mp4/validation";

std::string out_path	= "/home/yinghan/Downloads/TH14_validation_set_mp4/";
std::string out_path_jpeg	= "/home/yinghan/Downloads/TH14_validation_set_mp4/";
...
int main( int argc, char *argv[] )
{
	...
	const char* keys = "{ help      | false | print help message }"
				"{  start_video     |  1    | start video id }"
				"{gpuID     |  1    | use this gpu}"
				"{type     |  1    | use this flow method (0=Brox, 1=TV-L1)}"
				"{skip     |  2    | frame skip}"
				"{vid_path     |  /home/yinghan/Downloads/TH14_validation_set_mp4/validation/    | path input (where the videos are)}"
				"{out_path     |  /home/yinghan/Downloads/TH14_validation_set_mp4   | path output}";
	...
	if (argc > 1) {
		...
		out_path = cmd.get<std::string>("out_path")+"/tvl1_flow/";
		out_path_jpeg = cmd.get<std::string>("out_path")+ "/rgb/";
    ...
    static Ptr<cuda::BroxOpticalFlow> dflow= cv::cuda::BroxOpticalFlow::create(alpha_,gamma_,scale_factor_,inner_iterations_,outer_iterations_,solver_iterations_);

	static Ptr<cuda::OpticalFlowDual_TVL1> alg_tvl1=cv::cuda::OpticalFlowDual_TVL1::create();
		...
		QString file = dirIt.fileName();
			...
			while( frame1.empty() == false )
			{
				...
				if( nframes >= 1 )
				{
            		...
            		//get back flow map
            		GpuMat flow_x(planes[0]);
            		GpuMat flow_y(planes[1]);
					flow_x.download(imgU);//uGPU.download(imgU);
					flow_y.download(imgV);//vGPU.download(imgV);
